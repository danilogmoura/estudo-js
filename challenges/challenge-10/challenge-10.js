(function () {
    ...
    */
    function isOperatorValid(operationSignal) {
        return !!operation[operationSignal] ? true : false;
    }
    ...
    */
    function calculator(operationSignal) {
        return !isOperatorValid(operationSignal)
            ? false
            : function (number1, number2) {
                ...
                return operation[operationSignal](number1, number2);
            };
    }
    ...
    */
    function showOperationMessage(operationSignal, number1, number2) {
        return "A operação " + number1 + " " + operationSignal + " " + number2 + " =";
    };
    ...
    */
    function showErrorMessage(operationSignal) {
